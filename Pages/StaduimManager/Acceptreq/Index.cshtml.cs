...
namespace project.Pages.StaduimManager.Acceptreq;
...
public class IndexModel : PageModel
{
    ...
    public void OnPost() {
       ...
       command.Parameters.AddWithValue("@Smusername", Request.Form["username"].ToString());
        command.Parameters.AddWithValue("@Hostname", Request.Form["C1.Club_name"].ToString());
        command.Parameters.AddWithValue("@Guestname", Request.Form["C2.Club_name"].ToString());
        command.Parameters.AddWithValue("@starttime", Request.Form["start_time"].ToString());
