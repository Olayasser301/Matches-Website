...
namespace project.Pages.Matchs.Delete;
...
public class IndexModel : PageModel
{
    ...
    public void OnPost() {
       ...
       command.Parameters.AddWithValue("@name1", Request.Form["C1.Club_name"].ToString());
        command.Parameters.AddWithValue("@name2", Request.Form["C2.Club_name"].ToString());
        command.Parameters.AddWithValue("@start_time", Request.Form["start_time"].ToString());
        command.Parameters.AddWithValue("@end_time" ,Request.Form["end_time"].ToString());
